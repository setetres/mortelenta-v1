  ...
  <div class="flex flex-col items-center justify-center min-h-screen w-full">
    ...
    >
      <div class="relative w-full pointer-events-none">
        ...
        <svg
          class="w-full pointer-events-none relative z-30"
        ...
        <svg
          class="w-full h-full pointer-events-none absolute z-10 top-0 left-0"
          viewBox="0 0 1080 336"
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
      ...
      <div
        id="scythe"
        class="absolute top-0 right-0 bottom-0 left-0 pointer-events-none z-20"
      />
